...
namespace BiteMeBurgers.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        public AdminLanchesController(BancoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,preco,DescricaoCurta,DescricaoDetalhada,ImagemUrl,ImagemThumbnailUrl,IsLanchePreferido,EmEstoque,CategoriaId")] LancheModel lancheModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,preco,DescricaoCurta,DescricaoDetalhada,ImagemUrl,ImagemThumbnailUrl,IsLanchePreferido,EmEstoque,CategoriaId")] LancheModel lancheModel)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BancoContext.Lanches'  is null.");
            }
            var lancheModel = await _context.Lanches.FindAsync(id);
            if (lancheModel != null)
            {
