    ...
    public class AdminImagensController : Controller
    {
        ...
        public async Task<IActionResult> UploadFiles(List<IFormFile> files)
        {
            ...
            var filePath = Path.Combine(_webHostEnvironment.WebRootPath,
                _configurationImagens.NomePastaImagensLanches);
        ...
        public IActionResult GetImagens()
        {
            ...
            model.PathImagesLanche = _configurationImagens.NomePastaImagensLanches;
        ...
        public IActionResult Deletefile(string fname)
        {
            string _imagemDeleta = Path.Combine(_webHostEnvironment.WebRootPath,
                                                _configurationImagens.NomePastaImagensLanches + "\\", fname);
